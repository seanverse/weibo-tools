...
public class WbDataCubeArticleResult extends WbDataCubeBaseResult {
  ...
  public static List<WbDataCubeArticleResult> fromJson(String json) {
    return WbMpGsonBuilder.create().fromJson(
      JSON_PARSER.parse(json).getAsJsonObject().get("list"),
      new TypeToken<List<WbDataCubeArticleResult>>() {
      }.getType());
  }
