...
public class MediaImgUploadApacheHttpRequestExecutor extends MediaImgUploadRequestExecutor<CloseableHttpClient, HttpHost> {
  ...
  @Override
  public WeiboMediaImgUploadResult execute(String uri, File data, WeiboType weiboType) throws WeiboErrorException, IOException {
    if (data == null) {
    ...
    try (CloseableHttpResponse response = requestHttp.getRequestHttpClient().execute(httpPost)) {
      ...
      return WeiboMediaImgUploadResult.fromJson(responseContent);
    } finally {
