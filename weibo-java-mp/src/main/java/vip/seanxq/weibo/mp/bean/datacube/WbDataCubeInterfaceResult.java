...
public class WbDataCubeInterfaceResult extends WbDataCubeBaseResult {
  ...
  public static List<WbDataCubeInterfaceResult> fromJson(String json) {
    return WbMpGsonBuilder.create().fromJson(
      JSON_PARSER.parse(json).getAsJsonObject().get("list"),
      new TypeToken<List<WbDataCubeInterfaceResult>>() {
      }.getType());
  }
