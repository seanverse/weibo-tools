 ...
 * @author Binary Wang
 */
public interface WeiboMpUserService {
  /**
   * <pre>
   * 设置用户备注名
   ...
   * @param remark 备注名
   */
  void userUpdateRemark(String openid, String remark) throws WeiboErrorException;
   ...
   * @param openid 用户openid
   */
  WeiboMpUser userInfo(String openid) throws WeiboErrorException;
   ...
   */
  WeiboMpUser userInfo(String openid, String lang) throws WeiboErrorException;
   ...
   */
  List<WeiboMpUser> userInfoList(List<String> openidList) throws WeiboErrorException;
   ...
   */
  List<WeiboMpUser> userInfoList(WeiboUserQuery userQuery) throws WeiboErrorException;

  /**
   * <pre>
   * 获取用户列表
   * 公众号可通过本接口来获取帐号的关注者列表，
   * 关注者列表由一串OpenID（加密后的微博号，每个用户对每个公众号的OpenID是唯一的）组成。
   ...
   */
  WeiboMpUserList userList(String nextOpenid) throws WeiboErrorException;

  /**
   * <pre>
   * 微博公众号主体变更迁移用户 openid
   ...
   */
  List<WeiboMpChangeOpenid> changeOpenid(String fromAppid, List<String> openidList) throws WeiboErrorException;
}
