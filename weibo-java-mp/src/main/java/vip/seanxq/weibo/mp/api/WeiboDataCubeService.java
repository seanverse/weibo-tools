 ...
 */
public interface WeiboDataCubeService {
  //*******************用户分析数据接口***********************//
   ...
   */
  List<WbDataCubeUserSummary> getUserSummary(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度7天，endDate不能早于begingDate
   */
  List<WbDataCubeUserCumulate> getUserCumulate(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   */
  List<WbDataCubeArticleResult> getArticleSummary(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度1天，endDate不能早于begingDate
   */
  List<WbDataCubeArticleTotal> getArticleTotal(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   */
  List<WbDataCubeArticleResult> getUserRead(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度1天，endDate不能早于begingDate
   */
  List<WbDataCubeArticleResult> getUserReadHour(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度7天，endDate不能早于begingDate
   */
  List<WbDataCubeArticleResult> getUserShare(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度1天，endDate不能早于begingDate
   */
  List<WbDataCubeArticleResult> getUserShareHour(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度7天，endDate不能早于begingDate
   */
  List<WbDataCubeMsgResult> getUpstreamMsg(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度1天，endDate不能早于begingDate
   */
  List<WbDataCubeMsgResult> getUpstreamMsgHour(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   */
  List<WbDataCubeMsgResult> getUpstreamMsgWeek(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度30天，endDate不能早于begingDate
   */
  List<WbDataCubeMsgResult> getUpstreamMsgMonth(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   */
  List<WbDataCubeMsgResult> getUpstreamMsgDist(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度30天，endDate不能早于begingDate
   */
  List<WbDataCubeMsgResult> getUpstreamMsgDistWeek(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度30天，endDate不能早于begingDate
   */
  List<WbDataCubeMsgResult> getUpstreamMsgDistMonth(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度30天，endDate不能早于begingDate
   */
  List<WbDataCubeInterfaceResult> getInterfaceSummary(Date beginDate, Date endDate) throws WeiboErrorException;
   ...
   * @param endDate   最大时间跨度1天，endDate不能早于begingDate
   */
  List<WbDataCubeInterfaceResult> getInterfaceSummaryHour(Date beginDate, Date endDate) throws WeiboErrorException;
