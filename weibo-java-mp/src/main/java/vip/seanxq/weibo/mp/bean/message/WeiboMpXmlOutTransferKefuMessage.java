...
public class WeiboMpXmlOutTransferKefuMessage extends WeiboMpXmlOutMessage {
  private static final long serialVersionUID = 1850903037285841322L;

  @XStreamAlias("TransInfo")
  protected TransInfo transInfo;

  public WeiboMpXmlOutTransferKefuMessage() {
    this.msgType = WeiboConsts.KefuMsgType.TRANSFER_CUSTOMER_SERVICE;
  }
