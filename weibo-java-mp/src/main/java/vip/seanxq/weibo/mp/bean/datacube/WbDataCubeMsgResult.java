...
public class WbDataCubeMsgResult extends WbDataCubeBaseResult {
  ...
  public static List<WbDataCubeMsgResult> fromJson(String json) {
    return WbMpGsonBuilder.create().fromJson(
      JSON_PARSER.parse(json).getAsJsonObject().get("list"),
      new TypeToken<List<WbDataCubeMsgResult>>() {
      }.getType());
  }
