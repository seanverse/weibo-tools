 ...
 */
@Data
public class WeiboUserQuery implements Serializable {
   ...
   */
  public WeiboUserQuery(List<String> openids) {
    super();
    add(openids);
  }
   ...
   *
   * @param openids openid列表
   * @return {@link WeiboUserQuery}
   */
  public WeiboUserQuery add(List<String> openids) {
   ...
   * @return {@link WeiboUserQuery}
   */
  public WeiboUserQuery add(String openid, String lang) {
   ...
   * @return {@link WeiboUserQuery}
   */
  public WeiboUserQuery add(String openid) {
   ...
   * @return {@link WeiboUserQuery}
   */
  public WeiboUserQuery remove(String openid) {
   ...
   * @return {@link WeiboUserQuery}
   */
  public WeiboUserQuery remove(String openid, String lang) {
  ...
  public class WxMpUserQueryParam implements Serializable {
    ...
    private WeiboUserQuery getOuterType() {
      return WeiboUserQuery.this;
    }
