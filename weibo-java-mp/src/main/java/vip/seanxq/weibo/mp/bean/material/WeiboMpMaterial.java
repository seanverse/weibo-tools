...
@Data
public class WeiboMpMaterial implements Serializable {
  ...
  public WeiboMpMaterial() {
  }

  public WeiboMpMaterial(String name, File file, String videoTitle, String videoIntroduction) {
    this.name = name;
    this.file = file;
