...
import lombok.Data;
import vip.seanxq.weibo.common.util.json.WeiboBooleanTypeAdapter;
import vip.seanxq.weibo.common.util.json.WeiboDateTypeAdapter;
 ...
 */
@Data
public class WeiboMpCurrentAutoReplyInfo implements Serializable {
  ...
  public static WeiboMpCurrentAutoReplyInfo fromJson(String json) {
    return WbMpGsonBuilder.create().fromJson(json, WeiboMpCurrentAutoReplyInfo.class);
  }

  @SerializedName("is_add_friend_reply_open")
  @JsonAdapter(WeiboBooleanTypeAdapter.class)
  ...
  public static class AutoReplyRule implements Serializable {
    ...
    @JsonAdapter(WeiboDateTypeAdapter.class)
