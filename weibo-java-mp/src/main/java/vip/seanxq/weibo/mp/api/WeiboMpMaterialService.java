 ...
 * @author Binary Wang
 */
public interface WeiboMpMaterialService {
  /**
   * <pre>
   * 新增临时素材
   ...
   * 请注意：
   *  1、对于临时素材，每个素材（media_id）会在开发者上传或粉丝发送到微博服务器3天后自动删除（所以用户发送给开发者的素材，若开发者需要，应尽快下载到本地），以节省服务器资源。
   *  2、media_id是可复用的。
   ...
   * </pre>
   *
   * @param mediaType 媒体类型, 请看{@link WeiboConsts}
   * @param file      文件对象
   * @throws WeiboErrorException
   * @see #mediaUpload(String, String, InputStream)
   */
  WeiboMediaUploadResult mediaUpload(String mediaType, File file) throws WeiboErrorException;
   ...
   *
   * @param mediaType   媒体类型, 请看{@link WeiboConsts}
   * @param fileType    文件类型，请看{@link WeiboConsts}
   * @param inputStream 输入流
   * @throws WeiboErrorException
   * @see #mediaUpload(java.lang.String, java.io.File)
   */
  WeiboMediaUploadResult mediaUpload(String mediaType, String fileType, InputStream inputStream) throws WeiboErrorException;
   ...
   * @throws WeiboErrorException
   */
  File mediaDownload(String mediaId) throws WeiboErrorException;
   ...
   * @throws WeiboErrorException
   */
  File jssdkMediaDownload(String mediaId) throws WeiboErrorException;
   ...
   *
   * @param file 上传的文件对象
   * @return WeiboMediaImgUploadResult 返回图片url
   * @throws WeiboErrorException
   */
  WeiboMediaImgUploadResult mediaImgUpload(File file) throws WeiboErrorException;
   ...
   *
   * @param mediaType 媒体类型, 请看{@link WeiboConsts}
   * @param material  上传的素材, 请看{@link WeiboMpMaterial}
   */
  WeiboMpMaterialUploadResult materialFileUpload(String mediaType, WeiboMpMaterial material) throws WeiboErrorException;
   ...
   * </pre>
   *
   * @param news 上传的图文消息, 请看{@link WeiboMpMaterialNews}
   */
  WeiboMpMaterialUploadResult materialNewsUpload(WeiboMpMaterialNews news) throws WeiboErrorException;
   ...
   */
  InputStream materialImageOrVoiceDownload(String mediaId) throws WeiboErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  WeiboMpMaterialVideoInfoResult materialVideoInfo(String mediaId) throws WeiboErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  WeiboMpMaterialNews materialNewsInfo(String mediaId) throws WeiboErrorException;
   ...
   * </pre>
   *
   * @param weiboMpMaterialArticleUpdate 用来更新图文素材的bean, 请看{@link WeiboMpMaterialArticleUpdate}
   */
  boolean materialNewsUpdate(WeiboMpMaterialArticleUpdate weiboMpMaterialArticleUpdate) throws WeiboErrorException;
   ...
   * @param mediaId 永久素材的id
   */
  boolean materialDelete(String mediaId) throws WeiboErrorException;
   ...
   * </pre>
   */
  WeiboMpMaterialCountResult materialCount() throws WeiboErrorException;
   ...
   */
  WeiboMpMaterialNewsBatchGetResult materialNewsBatchGet(int offset, int count) throws WeiboErrorException;
   ...
   * </pre>
   *
   * @param type   媒体类型, 请看{@link WeiboConsts}
   * @param offset 从全部素材的该偏移位置开始返回，0表示从第一个素材 返回
   * @param count  返回素材的数量，取值在1到20之间
   */
  WeiboMpMaterialFileBatchGetResult materialFileBatchGet(String type, int offset, int count) throws WeiboErrorException;
