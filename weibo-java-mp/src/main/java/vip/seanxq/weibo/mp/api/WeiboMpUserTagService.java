 ...
 */
public interface WeiboMpUserTagService {
  /**
   * <pre>
   * 创建标签
   * 一个公众号，最多可以创建100个标签。
   ...
   * </pre>
   */
  List<WeiboUserTag> tagGet() throws WeiboErrorException;
   ...
   * </pre>
   */
  WeiboTagListUser tagListUser(Long tagId, String nextOpenid)
   ...
   * </pre>
   */
  boolean batchTagging(Long tagId, String[] openids) throws WeiboErrorException;
   ...
   * </pre>
   */
  boolean batchUntagging(Long tagId, String[] openids) throws WeiboErrorException;
   ...
   * @return 标签Id的列表
   */
  List<Long> userTagList(String openid) throws WeiboErrorException;
