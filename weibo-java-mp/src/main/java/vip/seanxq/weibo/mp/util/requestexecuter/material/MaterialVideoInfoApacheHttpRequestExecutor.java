...
public class MaterialVideoInfoApacheHttpRequestExecutor extends MaterialVideoInfoRequestExecutor<CloseableHttpClient, HttpHost> {
  ...
  @Override
  public WeiboMpMaterialVideoInfoResult execute(String uri, String materialId, WeiboType weiboType) throws WeiboErrorException, IOException {
    ...
    try (CloseableHttpResponse response = requestHttp.getRequestHttpClient().execute(httpPost)) {
      ...
      if (error.getErrorCode() != 0) {
        ...
        return WeiboMpMaterialVideoInfoResult.fromJson(responseContent);
      }
    } finally {
