...
public class WbDataCubeArticleTotal extends WbDataCubeBaseResult {
  ...
  private List<WbDataCubeArticleTotalDetail> details;

  public static List<WbDataCubeArticleTotal> fromJson(String json) {
    return WbMpGsonBuilder.create().fromJson(
      JSON_PARSER.parse(json).getAsJsonObject().get("list"),
      new TypeToken<List<WbDataCubeArticleTotal>>() {
      }.getType());
  }
