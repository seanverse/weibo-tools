 ...
 * @author codepiano
 */
public class WeiboMpNewsArticleGsonAdapter implements JsonSerializer<WeiboMpNewsArticle>, JsonDeserializer<WeiboMpNewsArticle> {
  @Override
  public JsonElement serialize(WeiboMpNewsArticle article, Type typeOfSrc, JsonSerializationContext context) {
  ...
  @Override
  public WeiboMpNewsArticle deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
