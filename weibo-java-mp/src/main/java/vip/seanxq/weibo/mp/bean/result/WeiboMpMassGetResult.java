 ...
 */
@Data
public class WeiboMpMassGetResult extends WeiboMpResult implements Serializable {
  ...
  public static WeiboMpMassGetResult fromJson(String json) {
    return WbMpGsonBuilder.create().fromJson(json, WeiboMpMassGetResult.class);
  }
