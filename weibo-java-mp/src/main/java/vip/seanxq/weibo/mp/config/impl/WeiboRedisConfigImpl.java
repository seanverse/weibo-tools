...
public class WeiboRedisConfigImpl extends WeiboDefaultConfigImpl {
  ...
  private final WeiboRedisOps redisOps;
  private final String keyPrefix;

  private String accessTokenKey;
  private String lockKey;

  public WeiboRedisConfigImpl(JedisPool jedisPool) {
    this(new JedisWeiboRedisOps(jedisPool), "wx");
  }

  public WeiboRedisConfigImpl(WeiboRedisOps redisOps, String keyPrefix) {
