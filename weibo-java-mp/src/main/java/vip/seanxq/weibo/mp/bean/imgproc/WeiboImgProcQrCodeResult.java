 ...
 */
@Data
public class WeiboImgProcQrCodeResult implements Serializable {
  ...
  public static WeiboImgProcQrCodeResult fromJson(String json) {
    return WbMpGsonBuilder.create().fromJson(json, WeiboImgProcQrCodeResult.class);
  }
