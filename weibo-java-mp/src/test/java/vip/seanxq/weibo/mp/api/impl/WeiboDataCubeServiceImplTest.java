...
public class WeiboDataCubeServiceImplTest {
  @Inject
  ...
  public void testGetUserSummary(Date beginDate, Date endDate)
    ...
    List<WbDataCubeUserSummary> summaries = this.wxService.getDataCubeService()
  ...
  public void testGetUserCumulate(Date beginDate, Date endDate)
    throws WeiboErrorException {
    List<WbDataCubeUserCumulate> result = this.wxService.getDataCubeService()
  ...
  public void testGetArticleSummary(Date date) throws WeiboErrorException {
    List<WbDataCubeArticleResult> results = this.wxService.getDataCubeService()
   ...
   */
  @Test(dataProvider = "oneDay")
  public void testGetArticleTotal(Date date) throws WeiboErrorException {
    List<WbDataCubeArticleTotal> results = this.wxService.getDataCubeService()
  ...
  @Test(dataProvider = "oneDay")
  public void testGetUserReadHour(Date date) throws WeiboErrorException {
    List<WbDataCubeArticleResult> results = this.wxService.getDataCubeService()
  ...
  @Test(dataProvider = "oneDay")
  public void testGetUserShareHour(Date date) throws WeiboErrorException {
    List<WbDataCubeArticleResult> results = this.wxService.getDataCubeService()
  ...
  @Test(dataProvider = "sevenDays")
  public void testGetUpstreamMsg(Date beginDate, Date endDate) throws WeiboErrorException {
    List<WbDataCubeMsgResult> results = this.wxService.getDataCubeService()
  ...
  @Test(dataProvider = "oneDay")
  public void testGetUpstreamMsgHour(Date date) throws WeiboErrorException {
    List<WbDataCubeMsgResult> results = this.wxService.getDataCubeService()
  ...
  public void testGetUpstreamMsgWeek(Date beginDate, Date endDate) throws WeiboErrorException {
    List<WbDataCubeMsgResult> results = this.wxService.getDataCubeService()
   ...
   */
  @Test(dataProvider = "thirtyDays")
  public void testGetUpstreamMsgMonth(Date beginDate, Date endDate) throws WeiboErrorException {
    List<WbDataCubeMsgResult> results = this.wxService.getDataCubeService()
  ...
  public void testGetUpstreamMsgDist(Date beginDate, Date endDate) throws WeiboErrorException {
    List<WbDataCubeMsgResult> results = this.wxService.getDataCubeService()
  ...
  @Test(dataProvider = "thirtyDays")
  public void testGetUpstreamMsgDistWeek(Date beginDate, Date endDate) throws WeiboErrorException {
    List<WbDataCubeMsgResult> results = this.wxService.getDataCubeService()
   ...
   */
  @Test(dataProvider = "thirtyDays")
  public void testGetUpstreamMsgDistMonth(Date beginDate, Date endDate) throws WeiboErrorException {
    List<WbDataCubeMsgResult> results = this.wxService.getDataCubeService()
  ...
  @Test(dataProvider = "thirtyDays")
  public void testGetInterfaceSummary(Date beginDate, Date endDate) throws WeiboErrorException {
    List<WbDataCubeInterfaceResult> results = this.wxService.getDataCubeService()
  ...
  @Test(dataProvider = "oneDay")
  public void testGetInterfaceSummaryHour(Date date) throws WeiboErrorException {
    List<WbDataCubeInterfaceResult> results = this.wxService.getDataCubeService()
