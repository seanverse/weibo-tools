 ...
 * @date 2019-08-05
 */
public class WeiboMpGetSelfMenuInfoResultTest {
  ...
  public void testFromJson() {
    ...
    final WeiboMpGetSelfMenuInfoResult selfMenuInfoResult = WeiboMpGetSelfMenuInfoResult.fromJson(json);
    ...
    final List<WeiboMpSelfMenuInfo.WxMpSelfMenuButton> buttons = selfMenuInfoResult.getSelfMenuInfo().getButtons();
