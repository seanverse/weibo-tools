...
@Test
public class WeiboMpXmlMessageTest {
  ...
  public void testFromXml() {
    ...
    String xml = "<xml>"
      ...
      + "</xml>";
    WeiboMpXmlMessage wxMessage = WeiboMpXmlMessage.fromXml(xml);
    ...
    assertEquals(wxMessage.getMsgType(), WeiboConsts.XmlMsgType.TEXT);
  ...
  public void testFromXml_MASSSENDJOBFINISH() {
    ...
    assertEquals(wxMessage.getMsgType(), WeiboConsts.XmlMsgType.EVENT);
