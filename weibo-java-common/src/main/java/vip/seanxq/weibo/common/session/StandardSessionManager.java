...
import vip.seanxq.weibo.common.util.res.StringManager;
 ...
 * @author Daniel Qian
 */
public class StandardSessionManager implements WeiboSessionManager, InternalSessionManager {
  ...
  @Override
  public WeiboSession getSession(String sessionId) {
    return getSession(sessionId, true);
  }

  @Override
  public WeiboSession getSession(String sessionId, boolean create) {
    if (sessionId == null) {
