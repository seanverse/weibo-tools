...
import vip.seanxq.weibo.common.annotation.Required;
...
public class BeanUtils {
   ...
   */
  public static void checkRequiredFields(Object bean) throws WeiboErrorException {
    ...
    if (!requiredFields.isEmpty()) {
      ...
      log.debug(msg);
      throw new WeiboErrorException(WeiboError.builder().errorMsg(msg).build());
    }
  }
