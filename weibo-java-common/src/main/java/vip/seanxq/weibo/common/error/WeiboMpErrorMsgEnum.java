...
public enum WeiboMpErrorMsgEnum {
  ...
  /**
   * 用户修改微博密码， accesstoken 和 refreshtoken 失效，需要重新授权.
   */
  CODE_42007(42007, "用户修改微博密码， accesstoken 和 refreshtoken 失效，需要重新授权"),
  /**
   * 需要 GET 请求.
   */
  ...
  /**
   * 客服帐号名长度超过限制 ( 仅允许 10 个英文字符，不包括 @ 及 @ 后的公众号的微博号 )(invalid kf_acount length).
   */
  CODE_61454(61454, "客服帐号名长度超过限制 ( 仅允许 10 个英文字符，不包括 @ 及 @ 后的公众号的微博号 )(invalid kf_acount length)"),
  /**
  ...
  WeiboMpErrorMsgEnum(int code, String msg) {
    this.code = code;
    this.msg = msg;
  }
  ...
  public static String findMsgByCode(int code) {
    for (WeiboMpErrorMsgEnum value : WeiboMpErrorMsgEnum.values()) {
      if (value.code == code) {
        return value.msg;
      }
    }
